            ...
            <main className="main">
               ...
               <div className="form-row">
                <div className="form-group boyut-group">
                 <h3>Boyut Seç *</h3>
                <label><input type="radio" name="boyut" onChange={handleChange}/>Küçük</label>
                <label><input type="radio" name="boyut" onChange={handleChange}/>Orta</label>
                <label><input type="radio" name="boyut" onChange={handleChange}/>Büyük</label>
                </div>
